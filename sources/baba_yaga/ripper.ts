...
// Baba Yaga runs its event promos through SpotHopper, a restaurant/bar
// marketing platform (same platform as sources/angry_beaver_seattle,
// sources/sullys_queen_anne, sources/bad_alberts). Its public JSON API
...
// Event photos are returned as numeric ids that resolve through a top-level
// `linked.images` collection rather than being embedded inline.
...
interface SpotHopperEvent {
    ...
    name: string;
    text?: string;
    event_date: string; // e.g. "2026-09-29T00:00:00.000+00:00" - the date portion is the intended local date
...
const VENUE_LOCATION = "Baba Yaga, 124 S Washington St, Seattle, WA 98104";
const VENUE_URL = "https://babayagaseattle.com/seattle-baba-yaga-events-days";
const SOURCE_ID = "baba-yaga";
...
export default class BabaYagaRipper extends JSONRipper {
