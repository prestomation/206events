...
**Before reading the queue**, close out the open PRs left by earlier cost
...
(`cost-resolver-*`, "Backfill cost gaps", "Drain costGaps"), plus any multi-queue "Queue drain" PR — those
