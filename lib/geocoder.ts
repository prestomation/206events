...
const KNOWN_VENUE_COORDS: Record<string, GeoCoords> = {
  ...
  // Bare prefix so any phrasing of the venue's address (e.g. seatoday's
  // "Pacific Science Center, 200 Second Ave. North, Seattle, WA" — abbreviated
  // "Ave." with a period, no zip — doesn't string-match the full-address entry
  // below) still resolves via lookupKnownVenue's startsWith match. The street
