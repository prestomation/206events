...
- venueName: "OHM Nightclub" (mixed case — DICE page titles auto-uppercase; pioneersquare.org and evendo.com both use "OHM Nightclub"; first CI attempt with "OHM NIGHTCLUB" produced 0 events + 1 parse error)
