...
**2026-09-08 re-check**: `/events` now renders mostly static/hardcoded
content — the one event shown ("Axe Kickers' Premierathon: Legend of the
Coin Seekers") is listed with "Next Date TBD" rather than a concrete date.
