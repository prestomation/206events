...
metro sample. Source domain: tukwilawa.gov.
...
**2026-09-23 (re-evaluated under King County rule, added):** Tukwila is in King County. The site runs The Events Calendar (Tribe), so the ICS feed `https://www.tukwilawa.gov/?post_type=tribe_events&ical=1&eventDisplay=list` works: food bank and resource days, hazardous-waste and recycling collections, Green Tukwila events, a farmers market, and council/commission meetings. Added as `sources/external/city-of-tukwila.yaml` (aggregator, geo null, tags Community + Tukwila). ONLY_SOURCE build: 30 events.
